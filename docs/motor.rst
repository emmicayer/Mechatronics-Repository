...
The file motor.py works with the motors using separate PWM and direction imputs in order to enable, disable, and drive the two motors on Romi independently. This file works with any motor object inputs. 
